...
mécanismes de data-binding vus jusqu'ici pour afficher l'id, le nom et les statistiques (moves, stats, abilities, image dans sprites/front_default, etc.) d'un pokémon qui sont accessibles dans https://pokeapi.co/api/v2/pokemon/{id} (exemple [https://pokeapi.co/api/v2/pokemon/1](https://pokeapi.co/api/v2/pokemon/1)).
