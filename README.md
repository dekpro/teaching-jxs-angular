...
Les pokémons se trouvent dans la partie "pokemon_entries" du résultat retourné par la requête http sur [http://pokeapi.co/api/v2/pokedex/1](http://pokeapi.co/api/v2/pokedex/1).
### Q12 : 
